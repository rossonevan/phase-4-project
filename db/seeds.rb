...
u2 = User.create(username: "Alex", password_digest: "1234")
u3 = User.create(username: "John", password_digest: "abc")
u4 = User.create(username: "Jim", password_digest: "abcd")
u5 = User.create(username: "Kevin", password_digest: "abc123")
...
e8 = Event.create(name: 'Chris Rock Ego Death World Tour 2022', location: 'Fox Theatre Detroit, Detroit, MI', date:'Sep 18', time:'7:00 OM', price: 70 , image: 'https://s1.ticketm.net/dam/a/a55/db61cae8-bcff-4c5c-a851-7e4bcbe9ca55_1731151_EVENT_DETAIL_PAGE_16_9.jpg')
